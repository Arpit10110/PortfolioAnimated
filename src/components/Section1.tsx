...
import PortfolioImg from "@/assets/new_profile.png"
                ...
                <div className='mt-[1rem] relative min-h-[80vh]' >
                    ...
                    <div className='flex justify-between px-[4rem] mt-[3rem] min-h-[35vh] items-center below-lap:px-[1rem] flex-wrap  below-lap:gap-[3rem] below-lap:justify-center below-tab:flex-col-reverse ' >
                        <div data-aos="fade-right" data-aos-delay="500" data-aos-duration="1000" data-aos-easing="ease-in-out" className='flex flex-col gap-[2rem] justify-start items-start w-[25%] below-lap:w-[50%] below-tab:w-[95%] below-tab:items-center   '>
                            ...
                            <a href="https://drive.google.com/file/d/1hFlbTQZrgxPvr5aHtLnoJzB-tAt4az2Q/view?usp=sharing" target='_blank' className="inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-slate-800 bg-[linear-gradient(125deg,#000000,45%,#28292b,55%,#000000)] bg-[length:200%_100%] px-6 font-medium text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 py-[2rem] text-[2.5rem] hover:scale-[1.03] transition-all  " >Download Resume</a>
                        ...
                        <div data-aos="zoom-in-up" data-aos-delay="1500" data-aos-duration="1000" className='w-[27vw] rounded-[5px] absolute bottom-[0%] right-[44%] border-none  below-lap:relative  below-lap:right-0 below-lap:w-[45vw]   below-tab:w-[45%] overflow-hidden ' >
                            <Image className='w-full h-auto object-cover rounded-[5px]' src={PortfolioImg} alt='Arpit Agrahari' priority />
                        </div>
